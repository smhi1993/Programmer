...
class Link 
	...
	//------------------------------------------------------------- 
	Link(int id, double dd) : iData(id), dData(dd), pNext(NULL)     //constructor  
		{  }                           
	//------------------------------------------------------------- 
...
class LinkList 
	...
	bool isEmpty()                 //true if list is empty 
		{ return pFirst==NULL; } 
	//------------------------------------------------------------- 
	void insertFirst(int id, double dd)   //insert at start of list 
	...
	//------------------------------------------------------------- 
	void displayList() 
		{ cout << “List (first-->last): “; Link* pCurrent = pFirst;    //start at beginning of list 
...
int main() 
	...
	while( !theList.isEmpty() )            //until it’s empty, 
		...
		cout << “Removing link with key “ 
			<< pTemp->iData << endl;   //display its key 
